                ...
                <div class="content">
                  <main class="content-primary">
                    <div class="content-fluid js-sort-article" data-sort-file="https://www.hulft.com/data/special_column/cat_json" data-sort-tmp="/common/js/data/tmp-column.html">
                      <div class="content-inner">
                        <p style={{fontWeight: 'bold'}}>ここにコンテンツを追加</p>
                        {props.data.allMicrocmsDemoSite.edges.map(edge =>
                          <div>
                            <p>{edge.node.title}</p>
                            <div dangerouslySetInnerHTML={createMarkup(edge.node.content)} />
                            {edge.node.image ? <div><img src={edge.node.image.url} /></div> : ''}
                          </div>
                        )}
